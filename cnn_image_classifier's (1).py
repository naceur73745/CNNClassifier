...
#here let devide the  the dtat set to validation and train 
...
#to make the work easyer we use a function to plott  th eimages 
...
#here we don t need the backpropragtion and  gradient's 
with torch.no_grad():
    n_correct = 0
    n_samples = 0
